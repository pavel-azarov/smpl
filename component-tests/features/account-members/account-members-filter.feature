Feature: Account Members Filtering
  ...
  Scenario Outline:  Filter account members - LIKE filters
    When I read account members list with following parameters
      | store_id   | page-limit | page-offset | ep-internal-search-json                                                         |
      | <STORE_ID> | 20         | 0           | {"name":"and","args":[{"name":"like","args":["<LIKE_FIELD>","<LIKE_FILTER>"]}]} |
    Then I see 200 status code in response
    And I see <RESULT_NUM> account members in the returned data with following parameters
      | name_prefix          | email_suffix          | user_ids          |
      | <RESULT_NAME_PREFIX> | <RESULT_EMAIL_SUFFIX> | <RESULT_USER_IDS> |
  ...
  Scenario Outline:  Filter account members - mixed filters
    When I read account members list with following parameters
      | store_id   | page-limit | page-offset | ep-internal-search-json                                                                                                                                         |
      | <STORE_ID> | 20         | 0           | {"name":"and","args":[{"name":"<FILTER_TYPE1>","args":["<LIKE_FIELD1>","<LIKE_FILTER1>"]},{"name":"<FILTER_TYPE2>","args":["<LIKE_FIELD2>","<LIKE_FILTER2>"]}]} |
    Then I see 200 status code in response
    And I see <RESULT_NUM> account members in the returned data with following parameters
      | name_prefix          | email_suffix          | user_ids          |
      | <RESULT_NAME_PREFIX> | <RESULT_EMAIL_SUFFIX> | <RESULT_USER_IDS> |
  ...
  Scenario Outline:  Filter account members - pagination
    When I read account members list with following parameters
      | store_id   | page-limit | page-offset | ep-internal-search-json                                                         |
      | <STORE_ID> | 1          | 0           | {"name":"and","args":[{"name":"like","args":["<LIKE_FIELD>","<LIKE_FILTER>"]}]} |
    Then I see 200 status code in response
    ...
    When I read account members list with following parameters
      | store_id   | page-limit | page-offset | ep-internal-search-json                                                         |
      | <STORE_ID> | 1          | 1           | {"name":"and","args":[{"name":"like","args":["<LIKE_FIELD>","<LIKE_FILTER>"]}]} |
    Then I see 200 status code in response
    And I see 1 account member in the returned data with following parameters
      | name_prefix          | email_suffix          | user_ids    |
  ...
  Scenario Outline:  Filter account members - store isolation
    And I mock EAS to return a successful user-authentication-info response 1 time with the following parameters
      | realmId                              | namePrefix       | emailSuffix           | userIds     |
      | 00000000-0000-1000-8000-111111111111 | wildcard*%_chars | @wildcard*%_chars.com | <USER_ID_3> |
    ...
    When I read account members list with following parameters
      | store_id         | page-limit | page-offset | ep-internal-search-json                                                         |
      | <OTHER_STORE_ID> | 20         | 0           | {"name":"and","args":[{"name":"like","args":["<LIKE_FIELD>","<LIKE_FILTER>"]}]} |
    Then I see 200 status code in response
